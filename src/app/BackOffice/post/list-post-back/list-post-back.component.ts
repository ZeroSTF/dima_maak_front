...
@Component({
  selector: 'app-list-post-back',
  templateUrl: './list-post-back.component.html',
  styleUrls: ['./list-post-back.component.css']
})
export class ListPostBackComponent {
  posts: Post[] = [];
  comments: Comment[] = [];
  ...
  showRatingChart(): void {
    this.router.navigate(['/admin/statPost']);
  }
